...
public class TampilPegawai extends AppCompatActivity implements View.OnClickListener {
    ...
    private void updateEmployee() {
        ...
        class UpdateEmployee extends AsyncTask<Void, Void, String> {
            private ProgressDialog loading = ProgressDialog.show(TampilPegawai.this, "Updating...", "Wait...", false, false);
    ...
    private void deleteEmployee() {
        ...
        class DeleteEmployee extends AsyncTask<Void, Void, String> {
            private ProgressDialog loading = ProgressDialog.show(TampilPegawai.this, "Updating...", "Tunggu...", false, false);
